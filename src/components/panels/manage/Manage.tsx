...
type Props = {
    showManagePanel: React.Dispatch<React.SetStateAction<boolean>>;
};

const Manage: React.FC<Props> = ({ showManagePanel }) => {
    const handleClose = () => {
    ...
    const handleViewClick = (staffId: number) => {
        setShowCardInfo(!showCardInfo);
        setSelectedStaffId(staffId);
    };

    return (
        <div className="bg-[#2e2e2e] w-full h-full absolute z-10 p-4">
