        ...
        <div className="Game-panel bg-[#2e2e2e] w-full h-full absolute z-10 p-4">
            <div className="rounded-3xl border-solid border-[#5e5745] border-4 h-[calc(100%-16px)] mt-4">
                <div className="rounded-[21px] border-solid border-[#ffedbb] border-4 bg-[#ffedbb] h-full relative">
                    ...
                    <div className="bg-[#fff8de] rounded-b-[20px] rounded-t border border-[#b5b5b5] absolute z-10 h-[calc(100%-32px)] p-[3px] overflow-hidden mt-8">
